...
### Fixed
- **USB device selection.** Ignore emulators and Wi-Fi devices, select a sole USB device automatically, ask when several are connected, and show ADB errors in Status.
